...
$plugin_name = 'superslider-login';
	...
	if ( !current_user_can('manage_options') ) {
		...
		elseif (isset($_POST['action']) && $_POST['action'] == 'update' ) {
			...
			echo '<div id="message" class="updated fade"><p><strong>' . __( 'login Options saved.', $plugin_name) . '</strong></p></div>';
...
<div id="ssslider" class="ui-tabs">
	...
	<tr>
		<td width="25%" align="center" valign="top"><img src="<?php echo WP_CONTENT_URL ?>/plugins/superslider-login/admin/img/default.png" alt="default" border="0" width="110" height="25" /></td>
		<td width="25%" align="center" valign="top"><img src="<?php echo WP_CONTENT_URL ?>/plugins/superslider-login/admin/img/blue.png" alt="blue" border="0" width="110" height="25" /></td>
		<td width="25%" align="center" valign="top"><img src="<?php echo WP_CONTENT_URL ?>/plugins/superslider-login/admin/img/black.png" alt="black" border="0" width="110" height="25" /></td>
		<td width="25%" align="center" valign="top"><img src="<?php echo WP_CONTENT_URL ?>/plugins/superslider-login/admin/img/custom.png" alt="custom" border="0" width="110" height="25" /></td>
	</tr>
	<tr>
