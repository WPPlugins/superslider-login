...
Slidein login panel, uses mootools 1.4.5

== Description ==

 A slide in login panel. Theme based, animated, automatic user detection, uses mootools 1.4.5 java script. This plugin is part of the SuperSlider series. Get more supersliders at [supersliders](http://wordpress.org/extend/plugins/superslider/ "SuperSliders")
