...
Description:  A slidein login panel. Theme based, animated, automatic user detection , uses mootools 1.4.5 java script.
Tags: login, slider, superslider, tab, tabs, mootools 1.4.5, mootools, register, slidetab
		...
		function login_setup_optionspage(){
			...
			if( function_exists('add_options_page') ) {
				if( current_user_can('manage_options') ) {
					...
					if (!class_exists('ssBase')) add_action('admin_print_scripts-'.$plugin_page, array(&$this,'ss_admin_style'));
